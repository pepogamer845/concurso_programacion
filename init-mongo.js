...
db.emission_factors.createIndex({ "category": 1, "type": 1, "region": 1 });
db.user_achievements.createIndex({ "user_id": 1, "achievement_name": 1 }, { unique: true });
db.user_recommendations.createIndex({ "user_id": 1, "recommendation_id": 1 });

// Insert default emission factors
db.emission_factors.insertMany([
  // Transport
